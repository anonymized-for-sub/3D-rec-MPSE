...
def load_dataset(dataset, n_points=1024):
...
def get_all_viewpoints(points, n_viewpoints, n_points_visible):
    labeled_perspectives = []
    perspectives, projection_mats = get_randomized_all_persps(points, n_viewpoints)
    for perspective in perspectives:
        labeled_perspectives.append(give_ids(perspective))
        
    labeled_perspectives = visible_in_n_persp(labeled_perspectives, n_points_visible)
    return labeled_perspectives

def get_raytracing(points, n_viewopints):
    labeled_perspectives = []
    perspectives, projection_mats = get_randomized_all_persps(points, n_viewopints)
    for perspective in perspectives:
        labeled_perspectives.append(give_ids(perspective))
